        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:40px 0 30px 0;background:#70bbd9;">
              <img src="https://phanmemmarketing.vn/wp-content/uploads/2022/03/Email-Marketing-va-Email-Sales.jpg" alt="" width="300" style="height:auto;display:block;" />
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    @if(isset($datas['name']))
                    <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;"><h2>Xin Chào: <i>{{ $datas['name'] }}</i></h2></h1>
                    @endif
                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        @if(isset($datas['pass']))
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a href="#" style="color:#ee4c50;text-decoration:underline;"><b style="color: blue"><i>Mật khẩu: </i></b>{{ $datas['pass'] }}<br></a></p>
                    @endif
                </td>
                </tr>
                <tr>
